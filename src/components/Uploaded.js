    ...
    return (
        <div>
            <div className='leftPart'>
                ...
                <a href='/uploaded' className='options'><RxDashboard /> Dashboard</a>
                <a href='/uploaded' className='options1'><FaPoll /> Upload</a>
                <a href='/uploaded' className='options2'><svg width="24" height="23" viewBox="0 0 24 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g opacity="0.4">
                    ...
                    Invoice</a>
                <a href='/uploaded' className='options3'><IoMdListBox /> Schedule</a>
                <a href='/uploaded' className='options4'><SlCalender /> Calender</a>
                <a href='/uploaded' className='options5'><IoIosNotifications /> Notification</a>
                <a href='/uploaded' className='options6'><IoMdSettings /> Settings</a>
            </div>
