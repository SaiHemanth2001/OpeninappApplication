    ...
    return (
        <div>
            <div className='leftPart'>
                ...
                <a  href='#' className='options'><RxDashboard /> Dashboard</a>
                <a  href='#' className='options1'><FaPoll /> Upload</a>
                <a  href='#' className='options2'><svg width="24" height="23" viewBox="0 0 24 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g opacity="0.4">
                    ...
                    Invoice</a>
                <a  href='#' className='options3'><IoMdListBox /> Schedule</a>
                <a  href='#' className='options4'><SlCalender /> Calender</a>
                <a  href='#' className='options5'><IoIosNotifications /> Notification</a>
                <a  href='#' className='options6'><IoMdSettings /> Settings</a>
            </div>
            <div className='rightPart'>
                ...
                <div className='browse'>
                    <div className='excelbrowse'>
                        ...
                        <p className='drop'>Drop your excel sheet here or <a  href='#' style={{ color: '#605BFF' }}>browse</a></p>
                    </div>
                    <a  href='#' className='uploadbutton'style={{ color: 'gray', pointerEvents: 'none', textDecoration: 'none', cursor: 'not-allowed',opacity: 0.7  }}><MdOutlineFileUpload /> Upload</a>
                </div>
               <h4 className='uploads'>Uploads</h4>
            </div>
        </div>
    )
}
